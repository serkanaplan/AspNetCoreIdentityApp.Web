...
public class MemberController(SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, IFileProvider fileProvider) : Controller
{
    ...
    // bu sadece çıkış işlemi yaptırır çıkış yaptıktan sonra yönlendirileceği sayfayı ilgili razorpage de yazdık
    ...
    [HttpGet]
    public IActionResult ExchangePage() => View();



    [Authorize(Policy = "ViolencePolicy")]
    [HttpGet]
    public IActionResult ViolencePage() => View();
